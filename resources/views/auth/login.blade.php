...
@section('title')
Gestion de Pharmacie: Se connecter
@endsection
...
> <!--style="background-image: url('../images/cap.jpg');"-->
  ...
  <div class="container" >
    <div class="row" >
      ...
      <div class="col-lg-6 col-12 mx-auto" >
        <div class="text-center pb-5"> <img src="../images/logo.png"> </div> <!--<img class="rounded-circle" width="90" alt="User Image" src="../images/logo.png">-->
